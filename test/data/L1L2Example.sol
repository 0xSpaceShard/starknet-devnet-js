...
contract L1L2Example {
    ...
    */
    ...
    function get_balance(uint256 user) external view returns (uint256) {
        return userBalances[user];
    }

    function withdraw(uint256 l2ContractAddress, uint256 user, uint256 amount) external {
    ...
    function deposit(uint256 l2ContractAddress, uint256 user, uint256 amount) external payable {
