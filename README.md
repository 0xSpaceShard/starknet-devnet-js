...
This library version is compatible with stable Devnet versions in the inclusive range: `v0.2.0-rc.0` - `v0.2.0-rc.1`.
...
async function main() {
    ...
    const devnet = await Devnet.spawnVersion("v0.2.0-rc.1");
